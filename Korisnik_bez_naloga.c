               ...
               void Quiz()
               {
                  ...
                  void Add_Comment_To_Event(LISTA *lista)
                  {
                     ...
                     void Print_Events_By_Time(LISTA *lista,int rezim)
                     {
                       ...
                       {
                       printf("-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------\n");
                       printf("|    OPCIJE :               PREGLED DANASNJIH DOGADJAJA(1)               PREGLED PROTEKLIH DOGADJAJA(2)               PREGLED BUDUCIH DOGADJAJA(3)               IGRANJE KVIZA(4)               |\n");
                       printf("------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|\n");
                       printf("|             KOMENTARISANJE(5)                              PREGLED GRADA(6)                   PREGLED DOGADJAJA PREMA KATEGORIJI(7)        PREGLED SVIH DOGADJAJA(8)                          |\n");
                       printf("-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------\n");
                       printf("|                                                                                  KRAJ(#)                                                                                                      |\n");
                       printf("-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------\n");
                       }
